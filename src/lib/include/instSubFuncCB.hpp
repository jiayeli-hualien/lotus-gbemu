...
SUB_FUNC_DECLARE(SRL);
SUB_FUNC_DECLARE(SRL_MEMVAL_MemWriteIndirectHL);
SUB_FUNC_DECLARE(BIT);
SUB_FUNC_DECLARE(BIT_MEMVAL);
SUB_FUNC_DECLARE(RES);
SUB_FUNC_DECLARE(RES_MEMVAL_MemWriteIndirectHL);
SUB_FUNC_DECLARE(SET);
SUB_FUNC_DECLARE(SET_MEMVAL_MemWriteIndirectHL);
}
